...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户评论表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DESKTOP-I8NUOFB1604840210599', 1604840257306, 15000);
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1604840210000, -1, 5, 'PAUSED', 'CRON', 1604840210000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1604840220000, -1, 5, 'PAUSED', 'CRON', 1604840210000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1604840220000, -1, 5, 'PAUSED', 'CRON', 1604840210000, 0, NULL, 2, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2073 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_role` VALUES (2, '普通管理员', 'common_admin', 2, '2', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2020-10-30 17:23:07', '普通管理员');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-11-08 20:42:36', 'admin', '2018-03-16 11:33:00', 'ry', '2020-11-08 20:42:36', '管理员');
...
INSERT INTO `sys_user` VALUES (100, 104, 'admin1', '普通管理员', '00', '2638090909@qq.com', '13112312313', '0', '', '3e2976ab649f68f20e9b19f81aa9c4bc', '0f6d6d', '0', '0', '127.0.0.1', '2020-11-07 19:36:01', 'admin', '2020-10-22 19:16:03', 'admin', '2020-11-07 19:36:01', '');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('75bb0d03-3341-46f5-9b55-46546933a0c6', 'admin', '超级管理员', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2020-11-08 20:42:34', '2020-11-08 20:57:12', 1800000);
...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of text_table
-- ----------------------------
INSERT INTO `text_table` VALUES (16, '树', '<ol><li>阿德福建卡时间段李开复</li><li>asdfas</li><li>asdfa</li><li>大沙发斯蒂芬</li></ol>', 'http://localhost:8080/profile/upload/2020/11/08/14bafd94-6e2f-4988-950e-62ddfdcfc486.txt', 101, '2020-10-17 00:00:00', 0, 0);
INSERT INTO `text_table` VALUES (17, '21132321', '<p><img src=\"http://localhost:8080/profile/upload/2020/11/08/9e52a9b2-cf9b-43ec-9b0a-8d2a7045d3d3.png\" style=\"width: 25%;\"><img src=\"http://localhost:8080/profile/upload/2020/11/08/53478da7-43b1-488f-a145-46ee964489b1.png\" style=\"width: 25%;\"><img src=\"http://localhost:8080/profile/upload/2020/11/08/c2441a51-3210-4141-87c0-3435349186f1.png\" style=\"width: 25%;\"><br></p>', 'http://localhost:8080/profile/upload/2020/11/08/8b8c7e56-8ebc-43bc-a261-91943fb901bf.png', 100, '2020-10-16 00:00:00', 0, 2);
...
CREATE TABLE `user_table`  (
  `userid` int(11) NOT NULL DEFAULT 0 AUTO_INCREMENT COMMENT '用户id',
...
-- ----------------------------
INSERT INTO `user_table` VALUES (1, 'user', 'user', 0, NULL, '123');
INSERT INTO `user_table` VALUES (2, '20202015120013', '123456', 0, 'http://localhost:8080/profile/upload/2020/11/08/0af8b9d4-cc33-4bdd-a645-ae9ad955221c.pptx', '18240704124');
INSERT INTO `user_table` VALUES (9, '20202015120013', '123456', 0, 'http://localhost:8080/profile/upload/2020/11/08/d0349a33-3b7a-42d1-827a-007037799c8d.pdf', '18240704816');
INSERT INTO `user_table` VALUES (10, '12', '12', 0, 'https://cube.elemecdn.com/9/c2/f0ee8a3c7c9638a54940382568c9dpng.png', '12');
INSERT INTO `user_table` VALUES (11, '1234', '1234', 0, 'https://cube.elemecdn.com/9/c2/f0ee8a3c7c9638a54940382568c9dpng.png', '1234');
INSERT INTO `user_table` VALUES (12, '11', '11', 0, 'https://cube.elemecdn.com/9/c2/f0ee8a3c7c9638a54940382568c9dpng.png', '11');
